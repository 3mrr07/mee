...
const DEPARTMENTS = [
  {
    ...
    about: {
      ar: "هندسة القوى الميكانيكية هي تخصص يركز على دراسة الطاقة، وكيفية تحويلها واستخدامها لتشغيل الآلات والأنظمة الميكانيكية المختلفة.",
      en: "Mechanical Power Engineering is a specialisation focused on studying energy, and how it is converted and used to operate various machines and mechanical systems."
    },
    careers: {
      ar: [
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h20"/><path d="M4 20V8l5 4V8l5 4V4h6v16"/></svg>', title: "المنشآت الصناعية", text: "إدارة وتطوير خطوط الإنتاج والمعدات الميكانيكية في المصانع." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>', title: "أنظمة التبريد والتكييف (HVAC)", text: "تصميم واختبار وتوفير حلول التكييف والتبريد للمباني والمنشآت الضخمة." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>', title: "محطات توليد الطاقة", text: "التشغيل والإشراف على محطات الطاقة الكهربائية والحرارية والتوربينات." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>', title: "تشغيل المنظومات الميكانيكية وأنظمة الطاقة الحرارية", text: "إدارة وتحليل كفاءة شبكات الضغط، الهيدروليك، والمنظومات الحرارية المتكاملة." }
      ],
      en: [
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h20"/><path d="M4 20V8l5 4V8l5 4V4h6v16"/></svg>', title: "Industrial plants", text: "Management and development of production lines and mechanical equipment in factories." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>', title: "HVAC systems", text: "Design, testing and providing air-conditioning and cooling solutions for large buildings and facilities." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>', title: "Power generation stations", text: "Operation and supervision of electric and thermal power stations and turbines." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>', title: "Mechanical & thermal energy systems", text: "Management and efficiency analysis of pressure, hydraulic and integrated thermal networks." }
      ]
    },
    guide: {
...

  {
    ...
    about: {
      ar: "تخصص هندسي لا يكتفي برسم الآلات والمنتجات على الورق، بل يدرس كيف نصنعها ونطورها ونحولها إلى منتج ملموس وقابل للتنفيذ في المصانع.",
      en: "An engineering specialisation that does not stop at drawing machines and products on paper — it teaches how to manufacture, develop and turn them into tangible products ready for factory production."
    },
    careers: {
      ar: [
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><circle cx="11" cy="11" r="2"/></svg>', title: "مهندس تصميم وتطوير", text: "ابتكار وتصميم الأجزاء والآلات والمعدات الميكانيكية وتحديد مواصفاتها." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h20"/><path d="M4 20V8l5 4V8l5 4V4h6v16"/></svg>', title: "مدير خطوط الإنتاج والعمليات", text: "الإشراف على العمليات التصنيعية وإدارتها وضمان كفاءة سلاسل الإنتاج." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>', title: "مهندس ضبط وجودة", text: "متابعة معايير الجودة والتصنيع لضمان خروج المنتجات بدون أي خطأ." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>', title: "إدارة المواد وقياسات التصنيع", text: "اختيار المواد الهندسية المناسبة وطرق تصنيعها واختبار متانتها وأبعادها في المصانع." }
      ],
      en: [
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><circle cx="11" cy="11" r="2"/></svg>', title: "Design Engineer", text: "Designing mechanical parts, machines and equipment and defining their specifications." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h20"/><path d="M4 20V8l5 4V8l5 4V4h6v16"/></svg>', title: "Production Manager", text: "Supervising and managing manufacturing operations and ensuring production chain efficiency." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>', title: "Quality Control Engineer", text: "Monitoring quality and manufacturing standards to ensure zero-defect output." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>', title: "Materials & Manufacturing Operations", text: "Selecting engineering materials, manufacturing methods and testing durability and dimensions." }
      ]
    },
    guide: {
...

  {
    ...
    careers: {
      ar: [
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8.5a14 14 0 0 1 20 0"/><path d="M5 12a9 9 0 0 1 14 0"/><path d="M8.5 15.5a4 4 0 0 1 7 0"/><circle cx="12" cy="19" r="1.2"/></svg>', title: "شركات الاتصالات ومزودي إنترنت", text: "تشغيل وإدارة شبكات الاتصالات الخلوية والألياف الضوئية والإنترنت." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.35-4.35"/></svg>', title: "إدارة وتصميم شبكات البيانات الضخمة", text: "بناء وتأمين وإدارة البنية التحتية للشبكات الحاسوبية والصناعية." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="5" width="14" height="14" rx="2"/><rect x="10" y="10" width="4" height="4"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3"/></svg>', title: "صيانة وتطوير الأنظمة الإلكترونية واللاسلكية", text: "تصميم واختبار وتطوير الدارات الإلكترونية والأنظمة اللاسلكية المتقدمة." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 10a12 12 0 0 1 16 0"/><path d="M6 14a7 7 0 0 1 12 0"/><circle cx="12" cy="17" r="2"/></svg>', title: "محطات البث والإرسال الرقمي", text: "الإشراف على منظومات الإرسال والاستقبال الميكروي والفضائي والبث الرقمي." }
      ],
      en: [
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8.5a14 14 0 0 1 20 0"/><path d="M5 12a9 9 0 0 1 14 0"/><path d="M8.5 15.5a4 4 0 0 1 7 0"/><circle cx="12" cy="19" r="1.2"/></svg>', title: "Telecom & ISPs", text: "Operating cellular, fibre-optic and internet networks." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.35-4.35"/></svg>', title: "Network Engineering & Data Infrastructure", text: "Building, securing and managing computer and industrial network infrastructure." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="5" width="14" height="14" rx="2"/><rect x="10" y="10" width="4" height="4"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3"/></svg>', title: "Electronic & Wireless Systems", text: "Designing, testing and developing advanced electronic and wireless systems." },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 10a12 12 0 0 1 16 0"/><path d="M6 14a7 7 0 0 1 12 0"/><circle cx="12" cy="17" r="2"/></svg>', title: "Digital Broadcasting & Transmission", text: "Supervising microwave, satellite and digital broadcast transmission systems." }
      ]
    },
    guide: {
...

  {
    ...
    about: {
      ar: "هندسة التحكم الآلي والحواسيب تخصص هندسي يهتم بتصميم وتطوير الأنظمة التي تجمع بين الحواسيب والإلكترونيات والبرمجة وأنظمة التحكم، بهدف تشغيل الأنظمة والآلات ومراقبتها والتحكم فيها بصورة آلية.",
      en: "Automatic Control & Computers Engineering is an engineering discipline concerned with designing and developing systems that combine computers, electronics, programming and control systems, with the aim of operating, monitoring and controlling systems and machines automatically."
    },
    careers: {
      ar: [
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h20"/><path d="M4 20V8l5 4V8l5 4V4h6v16"/></svg>', title: "نظم التحكم الآلي والأتمتة الصناعية", text: "برمجة وتشغيل خطوط الإنتاج والآلات الصناعية باستخدام المتحكمات القابلة للبرمجة (PLC) والنظم المدمجة" },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>', title: "البرمجيات وبنية الحواسيب والشبكات", text: "تطوير البرمجيات والنظم المدمجة وإدارة الشبكات وتطبيقات الذكاء الاصطناعي" },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="8" width="16" height="12" rx="2"/><path d="M12 4v4"/><path d="M9 4h6"/><circle cx="8.5" cy="13.5" r="1"/><circle cx="15.5" cy="13.5" r="1"/><path d="M9 16.5h6"/></svg>', title: "أنظمة الروبوتات والأنظمة الذكية", text: "تصميم وتطوير الروبوتات والأنظمة المستقلة وتكامل الحساسات مع وحدات التحكم" },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>', title: "الصيانة الدورية والإشراف الفني", text: "تشغيل وصيانة التجهيزات وأنظمة التحكم وحل المشكلات التقنية المعقدة" }
      ],
      en: [
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h20"/><path d="M4 20V8l5 4V8l5 4V4h6v16"/></svg>', title: "Automation & Industrial Control", text: "Programming production lines and machines with PLC and embedded systems" },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>', title: "Software, Architecture & Networks", text: "Software, embedded systems, networks and AI applications" },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="8" width="16" height="12" rx="2"/><path d="M12 4v4"/><path d="M9 4h6"/><circle cx="8.5" cy="13.5" r="1"/><circle cx="15.5" cy="13.5" r="1"/><path d="M9 16.5h6"/></svg>', title: "Robotics & Smart Systems", text: "Designing robots and autonomous systems with sensors and controllers" },
        { icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>', title: "Supervision & Maintenance", text: "Operating equipment and control systems, solving complex issues" }
      ]
    },
    guide: {
