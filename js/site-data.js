...
const COURSES_EN = {
  ...
  "الثقافة القومية الاشتراكية": "National Socialist Culture",
  "الثقافة القومية والاشتراكية": "National and Socialist Culture",
  ...
  "السبك آلاته": "Casting and Its Machines",
...
const DEPARTMENTS = [
  {
    ...
    years: [
      [["الرياضيات/1", "الفيزياء/1", "اللغة الأجنبية/1", "الهندسة الوصفية", "الكيمياء الصناعية", "اللغة العربية"],
        ["الرياضيات/2", "اللغة الأجنبية/2", "الفيزياء/2", "الثقافة القومية الاشتراكية", "الرسم الهندسي/1", "الميكانيك الهندسي/1"]],
...

  {
    ...
    years: [
      [["الرياضيات/1", "الفيزياء/1", "اللغة الأجنبية/1", "الهندسة الوصفية", "الكيمياء الصناعية", "اللغة العربية"],
        ["الرياضيات/2", "اللغة الأجنبية/2", "الفيزياء/2", "الرسم الهندسي/1", "الميكانيك الهندسي/1", "الثقافة القومية الاشتراكية"]],
      ...
      [["علوم الليزر الصناعي", "أسس الروبوت الصناعي", "الصيانة والأمن الصناعي", "نظرية قطع المعادن", "المواد المركبة"],
        ["آلات التشكيل والتشغيل", "هندسة اللدائن", "التنظيم والاقتصاد الصناعي", "السبك آلاته", "تصميم القوالب المعدنية"]]
     ]
  },

  {
    ...
    years: [
      [["الرياضيات/1", "الفيزياء/1", "مبادئ عمل الحواسيب", "الميكانيك الهندسي", "الثقافة القومية الاشتراكية", "اللغة الأجنبية/1"],
...

  {
    ...
    years: [
      [["الرياضيات/1", "الفيزياء/1", "الميكانيك الهندسي", "مبادئ عمل الحواسيب", "الثقافة القومية الاشتراكية", "اللغة الأجنبية/1"],
...

  {
    ...
    years: [
      [["الرياضيات/1", "الفيزياء", "اللغة الأجنبية/1", "مبادئ عمل الحاسوب", "الرسم والتمثيل الهندسي", "الثقافة القومية والاشتراكية", "الكيمياء الصناعية"],
...

  {
    ...
    years: [
      [["الرياضيات/1", "الفيزياء/1", "الهندسة الوصفية", "الكيمياء العامة والتحليلية/1", "اللغة الأجنبية/1", "اللغة العربية"],
        ["الرياضيات/2", "الفيزياء/2", "الرسم الهندسي/1", "الكيمياء العامة والتحليلية/2", "الثقافة القومية الاشتراكية", "اللغة الأجنبية/2"]],
